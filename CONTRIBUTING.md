...
Welcome to `thesis` contributor's guide.
...
If you experience bugs or general issues with `thesis`, please have a look
...
You can help improve `thesis` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`thesis` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `thesis`'s files. While this mechanism can
...
```
conda create -n thesis python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/thesis.git
   cd thesis
   ```
...
5. Install [pre-commit]:
   ...
   `thesis` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/thesis
[issue tracker]: https://github.com/<USERNAME>/thesis/issues
